const text1_options = [
  ...
  "Dom (Document Objek Model) adalah cara bagi javasript untuk berinteraksi dengan halaman web.",
  "Menggunakan Dom dapat mengubah teks,gambar,warna dan tata letak halaman web.",
  "Elemen HTML sebagai objek,properties dan event element HTML,Method untuk mengakses element HTML.",
];
const text2_options = [
  "sejarah",
  "Pengenalan DOM",
